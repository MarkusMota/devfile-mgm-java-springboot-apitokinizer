 ...
 * @since JDK 17
 */
public interface ILdapApiRestClient {
	 ...
	 */
	public LdapResponseDTO authorizationLDAP(TokenizerDTO tokenizerDTO)  throws IOException, InterruptedException, NoSuchAlgorithmException, KeyManagementException ;
